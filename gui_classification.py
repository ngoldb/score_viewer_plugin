...
class ClassificationTab:
    ...
    def __init__(self, plugin):
        ...
        left_column.addWidget(QLabel("Good models"))
        self.good_models_list = QListWidget()
        left_column.addWidget(self.good_models_list)
        self.good_models_list.itemClicked.connect(self.item_clicked)

        right_column = QVBoxLayout()
        right_column.addWidget(QLabel("Bad models"))
        self.bad_models_list = QListWidget()
        right_column.addWidget(self.bad_models_list)
